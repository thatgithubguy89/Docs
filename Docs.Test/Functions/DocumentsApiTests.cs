...
namespace Docs.Test.Functions
{
    public class DocumentsApiTests
    {
        ...
        Mock<IPagingService<Document, DocumentDto>> _mockPagingService;
        IMapper _mapper;
        ...
        public void Setup()
        {
            ...
            _mockPagingService = new Mock<IPagingService<Document, DocumentDto>>();
        ...
        public async Task GetAllDocuments()
        {
            ...
            _mockPagingService.Setup(p => p.Page(It.IsAny<List<Document>>(), It.IsAny<int>(), It.IsAny<float>())).Returns(new PageResponse<DocumentDto>());
            var documentsApi = new DocumentsApi(_mockDocumentRepository.Object, _mockLogger.Object, _mapper, _mockPagingService.Object);
            var request = Generator.GenerateMockRequest();

            var actionResult = await documentsApi.GetAllDocuments(request, 1);
            var result = actionResult as OkObjectResult;

            result.Value.ShouldBeOfType<PageResponse<DocumentDto>>();
